...
WebSocketSignalingChannel.prototype.connectWebSocket = function () {
    ...
    var websocket_url = 'wss://doorbell.dingodesign.ca:8888/';
...
WebSocketSignalingChannel.prototype.onWebSocketMessage_ = function (event) {
    ...
    this.peerConnectionClient_.onReceivePeerMessage(message);
    //}
};
...
WebSocketSignalingChannel.prototype.doSignalingConnect = function () {
    ...
    if( window.WebSocket ){
        ...
        this.peerConnectionClient_.getUserMedia(this.connectWebSocket.bind(this));
    }else{
...
WebSocketSignalingChannel.prototype.doSignalingRegister = function () {
    ...
    let register_message = JSON.stringify(message);
    this.WebSocketSendMessage(register_message);
};

WebSocketSignalingChannel.prototype.doSignalingSend = function (message) {
    /*let message = { cmd: "send",
    ...
    let data_message = JSON.stringify(message);
